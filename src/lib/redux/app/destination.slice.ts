...
const destinationSlice = createSlice({
  ...
  reducers: {
    ...
    setLimitOrPageDestination: (state, action: { payload: { limit?: number; page?: number } }) => {
...
export const { refreshDataDestination, resetDataDestination, setDataDestinations, setLimitOrPageDestination } = destinationSlice.actions;
